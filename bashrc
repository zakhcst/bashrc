...
export KWIN_IGNORE_SHADER_MANAGER_SELF_TEST=1

# If not running interactively, don't do anything
[[ $- != *i* ]] && return

alias ls='ls --color=auto'
#PS1='\e[0;31m[\u@\h]\e[0;32m[$PWD]\n\e[0m[\W]\$ '
#PS1='\[\e[0;31m\][\u@\h]\[\e[0;32m\][$PWD]\n\[\e[0m\][\W]\$ '

PS1='\[\e[1;38;5;242m\][\[\e[1;38;5;214m\]\u\[\e[1;38;5;242m\]@\[\e[1;38;5;161m\]\h\[\e[1;38;5;242m\] \D{%d/%m/%y %H:%M:%S} [$PWD]\n\[\e[1;38;5;33m\][\W]\[\e[1;38;5;242m\]\[\e[0m\]$'

alias l='ls -l --color'
alias ll='ls -al --color'
alias lk='ls -al -C --color'
alias cc='clear'
alias sc='systemctl' 
...
## PS1 CONFIG {{{
  ...
  if $_isxrunning; then
    ...
    export  B='\[\e[1;38;5;33m\]'
    export LB='\[\e[1;38;5;81m\]'
    export GY='\[\e[1;38;5;242m\]'
    export  G='\[\e[1;38;5;82m\]'
    export  P='\[\e[1;38;5;161m\]'
    export PP='\[\e[1;38;5;93m\]'
    export  R='\[\e[1;38;5;196m\]'
    export  Y='\[\e[1;38;5;214m\]'
    export  W='\[\e[0m\]'
...
# [\W]\[\e[1;38;5;242m\]\[\e[0m\]
       PS1="\[\e[1;38;5;242m\][\[\e[1;38;5;214m\]\u\[\e[1;38;5;242m\]@\[\e[1;38;5;161m\]\h\[\e[1;38;5;242m\] \D{%d/%m/%y %H:%M:%S} \w]\n\[\e[1;38;5;33m\]$GY[$Y\u$GY@$P\h$GY:$B\W\$(__git_ps1 \"$GY|$LB%s\")$GY]$W\$(get_prompt_symbol) "
    else
       PS1="\[\e[1;38;5;242m\][\[\e[1;38;5;214m\]\u\[\e[1;38;5;242m\]@\[\e[1;38;5;161m\]\h\[\e[1;38;5;242m\] \D{%d/%m/%y %H:%M:%S} \w]\n\[\e[1;38;5;33m\]$GY[$Y\u$GY@$P\h$GY:$B\W$GY]$W\$(get_prompt_symbol) "
    fi
  else
...
## FUNCTIONS {{{
  ...
  dockac(){ 
	...
	# show all containers ips
  docip(){ 
       (docker ps) | awk '{ if ($1=="CONTAINER") {  } 
        else {  printf("echo \"%s  %s  $(docker inspect --format '"'"'{{ .NetworkSettings.IPAddress }}  {{ .NetworkSettings.Gateway}}  {{ .Name }}'"'"' %s)\
                \"\n",$2,$1,$1); } 
        }'  > "TmPfIlE" 
        chmod +x TmPfIlE
        ./TmPfIlE | sed 's/\///g' 
	...
	alias docaddr="docker inspect --format '{{ .NetworkSettings.IPAddress }}'"

	alias docsrac="docsac;docrac"
...
#showmax(){
#ls -lRh | awk '{print $1, $5, $9}' | grep '^-' | awk '{print $2 $3}' | sort -hrk 1 | head -n 10
#ls -lRh /home/sdr/ | grep "^-" | awk '{print $5, $9;}' | sort -hk 1 | tail -n 20 | awk '{ xcmd="find / -name "$2; system(xcmd); }'
#}
...
maxfs(){
#  ls -lRh /home/sdr/ | grep "^-" | awk '{print $5, $9;}' | sort -hk 1 | tail -n 20 | tee | awk '{ xcmd="find / -name "$2; system(xcmd); }'
	ls -lRh $1 | grep "^-" | awk '{print $5, $9;}' | sort -hk 1 | tail -n 20
}
maxdu(){
	du $1 | sort -hk 1 | tail -n 20
}
